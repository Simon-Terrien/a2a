...
AGENT_COLLABORATION_RULES = {
    'sqli': ['auth', 'input'],  # SQL injection often related to auth bypass and input validation
    'xss': ['input', 'config'], # XSS related to input validation and CSP configuration
    'auth': ['session', 'config'], # Auth issues often relate to session and configuration
    'crypto': ['secrets', 'config'], # Crypto issues relate to secrets and configuration
