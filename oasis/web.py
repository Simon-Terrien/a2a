...
class WebServer:
    ...
    def __init__(self, report, debug=False, web_expose='local', web_password=None, web_port=5000,
                 agent_manager=None, mcp_tools=None):
        """
    ...
    def register_routes(self, app, server, login_required):
        ...
        def get_stats():
            ...
            if any([model_filter, format_filter, vuln_filter, start_date, end_date, agent_filter]):
    ...
    def filter_reports(self, model_filter='', format_filter='', vuln_filter='', start_date=None, end_date=None, 
                      md_dates_only=True, agent_filter=''):
        ...
        if agent_filter:
            ...
            filtered = [r for r in filtered if r.get('agent', '').lower() in agent_filters]
    ...
    def _get_agent_findings(self, agent_type):
        ...
        findings['recent_findings'] = sorted(agent_reports, key=lambda x: x.get('date', ''), reverse=True)[:10]
    ...
    def _get_collaboration_data(self):
        ...
        return {
            ...
            'collaboration_rules': getattr(self.agent_manager, 'collaboration_rules', {}),
